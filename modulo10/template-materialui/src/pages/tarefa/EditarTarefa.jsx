          ...
          <Grid container spacing={2} mt={1}>
            ...
            <Grid container spacing={2} pl={2} mt={2}>
              <Grid item xs={12} sm={6}>
                <Button size="small" fullWidth variant="contained" onClick={handleEditar}>Salvar</Button>
              </Grid>  
              <Grid item xs={12} sm={6}>  
                <Button size="small" fullWidth variant="outlined" onClick={handleCloseEditar}>Cancelar</Button>  
              </Grid>
            </Grid>  
          </Grid>
        </CardContent>
